...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>Ngaduin.aja</span></a></h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Aplikasi Pengaduan Masyarakat <span>Ngaduin.aja</span></h1>
        ...
        <div class="col-md-4" data-aos="fade-right">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left" id="how">
            ...
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
              ...
              <h4 class="title"><a href="">Masalah anda akan segera di prodes</a></h4>
            </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Ngaduin.aja</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">roziqmbrk</a>
      </div>
    </div>
  </footer><!-- End Footer -->
